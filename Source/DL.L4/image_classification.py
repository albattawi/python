...
# Use set_image_data_format() to be compatible with keras version: 2.4.3 and 'channel_last'
...
for x in range(4):
    print('Predect Img_Test',x,': ',predectlist[x])
    plt.imshow(X_test[x],aspect='auto')
    plt.show()
    print('Actual label:',[numpy.argmax(y_test[x])])
